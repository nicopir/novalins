...
class QuotationsControllerTest < ActionController::TestCase
  ...
  test "should create quotation" do
    assert_difference('Quotation.count') do
      post :create, quotation: { file_path: @quotation.file_path, name: @quotation.name, project_id: @quotation.project_id }
    end
  ...
  test "should update quotation" do
    patch :update, id: @quotation, quotation: { file_path: @quotation.file_path, name: @quotation.name, project_id: @quotation.project_id }
    assert_redirected_to quotation_path(assigns(:quotation))
  end
